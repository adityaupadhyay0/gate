         ...
         {(aiExplanation || aiError) && (
           <motion.div
             ...
             className={cn(
               ...
               aiError ? "border-amber-500/50" : "border-brand-500/30"
             )}
           >
              <div className="flex items-center gap-3 mb-6 md:mb-8">
                 <div className={cn(
                   ...
                   aiError ? "bg-amber-500" : "bg-brand-500"
                    ...
                    {aiError ? <Zap className="w-5 h-5 md:w-6 md:h-6" /> : <BrainCircuit className="w-5 h-5 md:w-6 md:h-6" />}
                 </div>
                 <div>
              ...
              <div className="prose prose-invert max-w-none font-medium leading-relaxed text-slate-300 text-sm md:text-base">
                 {aiError ? (
                   <div className="p-4 bg-amber-500/10 border border-amber-500/20 rounded-xl">
                      <p className="text-amber-200 font-bold">{aiError}</p>
                   </div>
                 ) : (
