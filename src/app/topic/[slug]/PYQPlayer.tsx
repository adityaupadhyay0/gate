      ...
      <AnimatePresence>
         {(aiExplanation || aiError) && (
           <motion.div
             ...
             exit={{ opacity: 0, y: 20 }}
             className={cn(
               "premium-card p-6 md:p-10 bg-slate-900 border-2 text-white",
           ...
           >
              <div className="flex items-center gap-3 mb-6 md:mb-8">
                 ...
                 <div>
                    ...
                    <p className={cn(
                      ...
                      {aiError ? "Usage Policy" : "Gemini 1.5 Pro Analysis"}
                    </p>
                 </div>
              ...
              {aiError ? (
                <div className="bg-red-500/10 border border-red-500/20 rounded-2xl p-6">
                  <p className="text-red-200 font-bold leading-relaxed text-sm md:text-base">
                    {aiError}
                  </p>
                </div>
              ) : (
